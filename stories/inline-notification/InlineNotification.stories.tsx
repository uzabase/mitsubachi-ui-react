...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'InlineNotification は、ユーザーの操作に対して即座に理解すべきエラーや時間的制約のある情報を、画面の文脈の中で提示するための通知コンポーネントです。\n\n' +
          'Overlay ではなく UI の一部として常に表示されるため、ユーザーが見逃すことがありません。\n\n' +
          '### 使い方のルール\n\n' +
          '- **失敗・警告・エラーなど、見逃してほしくない重要な情報の通知** — UIの一部として常に表示されるため、ユーザーが確実に認識できます\n' +
          '- **成功時の短いフィードバック** — `Snackbar` を使用してください',
      },
    },
  },
  decorators: [
